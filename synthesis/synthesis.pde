...
void setup() {
  ...
  s[1] = p5.addSlider("gainSlider1").setPosition(410, 70).setSize(180, 15).setRange(0, 1).setValue(baseFrequency).setLabel("1").hide();
  s[2] = p5.addSlider("gainSlider2").setPosition(410, 90).setSize(180, 15).setRange(0, 1).setValue(baseFrequency).setLabel("2").hide();
  s[3] = p5.addSlider("gainSlider3").setPosition(410, 110).setSize(180, 15).setRange(0, 1).setValue(baseFrequency).setLabel("3").hide();
  s[4] = p5.addSlider("gainSlider4").setPosition(410, 130).setSize(180, 15).setRange(0, 1).setValue(baseFrequency).setLabel("4").hide();
  s[5] = p5.addSlider("gainSlider5").setPosition(410, 150).setSize(180, 15).setRange(0, 1).setValue(baseFrequency).setLabel("5").hide();
  s[6] = p5.addSlider("gainSlider6").setPosition(410, 170).setSize(180, 15).setRange(0, 1).setValue(baseFrequency).setLabel("6").hide();
  s[7] = p5.addSlider("gainSlider7").setPosition(410, 190).setSize(180, 15).setRange(0, 1).setValue(baseFrequency).setLabel("7").hide();
  s[8] = p5.addSlider("gainSlider8").setPosition(410, 210).setSize(180, 15).setRange(0, 1).setValue(baseFrequency).setLabel("8").hide();
  s[9] = p5.addSlider("gainSlider9").setPosition(410, 230).setSize(180, 15).setRange(0, 1).setValue(baseFrequency).setLabel("9").hide();
